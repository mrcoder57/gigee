...
export default function NotFound() {
  return (
    <div className="min-h-screen bg-gradient-to-b py-16 md:py-0 lg:py-0 from-gray-50 to-gray-100 flex items-center justify-center p-4 sm:p-6 lg:p-8">
      <div className="max-w-6xl flex items-center w-full">
        <div className="flex flex-col md:flex-row-reverse items-center md:items-center justify-between w-full gap-y-8">
