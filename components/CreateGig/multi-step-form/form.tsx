...
const MultiStepForm: React.FC = () => {
  ...
  const [formValues, setFormValues] = useState({ email: '', password: '', age: 0 });
  ...
  switch (step) {
    ...
    case 3:
      return <Step3 prevStep={prevStep} handleSubmit={handleSubmit} handleChange={handleChange} values={formValues} />;
    default:
