...
const Footer = () => {
  return (
   <div className="mt-5 ml-2  mr-2 sm:gap-2 lg:gap-8 ">
     <Box
      as="footer"
      className="bg-gray-100 border-t border-gray-300 py-8 text-sm"
      w="full"
    >
      <Box
        maxW="64rem"
